...
class ConnectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connect" do
    assert_difference('Connect.count') do
      post connects_url, params: { connect: { collection_id: @connect.collection_id, listing_id: @connect.listing_id, user: @connect.user } }
    end
  ...
  test "should update connect" do
    patch connect_url(@connect), params: { connect: { collection_id: @connect.collection_id, listing_id: @connect.listing_id, user: @connect.user } }
