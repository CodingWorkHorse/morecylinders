...
class CollectionsTest < ApplicationSystemTestCase
  ...
  test "creating a Collection" do
    ...
    fill_in "Collection author", with: @collection.collection_author
    fill_in "Collection image", with: @collection.collection_image
    fill_in "Description", with: @collection.description
    fill_in "Status", with: @collection.status
